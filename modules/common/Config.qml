            ...
            property JsonObject hyprland: JsonObject {
                ...
                property JsonObject general: JsonObject {
                    ...
                    property JsonObject borderColor: JsonObject {
                        property bool enable: false
                        // A palette role name resolved by Appearance.getColorFromName(),
                        // or "custom" to use the matching *Custom hex below.
                        property string activeRole: "outlineVariant"
                        property string inactiveRole: "surfaceContainerLow"
                        property string activeCustom: "#8AB4F8"
                        property string inactiveCustom: "#2A2F37"
                        // 0.467 and 0.2 are the 0x77 / 0x33 alphas the matugen
                        // template uses, so the defaults reproduce it exactly.
                        property real activeOpacity: 0.467
